...
export const site = {
  ...
  coFounder: {
    ...
    bio: 'Sanyogita is Co-Founder & Director at ASANYX Analytics, leading the practice for Business Intelligence delivery, dashboard engineering and client engagement. She brings four years of hands-on experience in Power BI, DAX and SQL, and partners with clients to translate complex data into clear, decision-ready insight.',
    bio2: 'At ASANYX, she is responsible for shaping delivery standards, quality assurance and stakeholder collaboration across engagements - ensuring every dashboard, model and report we build measurably improves how our clients make decisions.'
  },
